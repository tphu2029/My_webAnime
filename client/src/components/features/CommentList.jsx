        ...
        <div key={comment._id} className="flex items-start space-x-4">
          <img
            src={
              ...
              `https://ui-avatars.com/api/?name=${comment.user.displayName}&background=random`
            }
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1 text-gray-300 whitespace-pre-wrap wrap-break-words">
              {comment.content}
            </p>
          </div>
        </div>
